...
## Corpus Check
- 76 files · ~44,949 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 709 nodes · 1613 edges · 36 communities detected
- Extraction: 61% EXTRACTED · 39% INFERRED · 0% AMBIGUOUS · INFERRED: 623 edges (avg confidence: 0.74)
...
Cohesion: 0.06
Nodes (39): _cmd_cluster_preflight(), _cmd_doctor(), _cmd_estimate(), _cmd_train(), _config_value(), _has_prepared_training_inputs(), _parse_split_windows(), ConfigError (+31 more)
...
Cohesion: 0.07
Nodes (37): EvalCommandConfig, event_manifest_summary(), _jsonable(), load_event_batches(), _loads_json(), Persist prepared event batches for offline training/eval jobs., Persist prepared event batches for offline training/eval jobs., Persist prepared event batches for offline training/eval jobs. (+29 more)
...
Cohesion: 0.09
Nodes (40): Audit prepared eval inputs before any benchmark score is trusted., _add_degenerate_ci(), _add_degenerate_task_metric_ci(), _aggregate_seed_metrics(), _aggregate_seed_ranks(), build_prepared_window_tasks(), _collect_aggregate_seed_ranks(), _collect_concrete_seed_ranks() (+32 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (37): format_prepared_eval_audit(), _cmd_eval(), EvalCommandResult, _manifest_pair_error(), _prepared_suite_config(), _run_audit_command(), run_eval_command(), _run_neural_translation_v1_command() (+29 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (23): audit_split_manifest(), AuditReport, _forbidden_metadata(), _metadata_group_overlap(), _window_overlap(), _cmd_split_audit(), check_manifest_leakage(), LeakageReport (+15 more)

### Community 8 - "Community 8"
Cohesion: 0.14
Nodes (24): _cmd_data_prepare(), _cmd_data_smoke(), record_to_dict(), save_data_manifest(), save_leakage_report(), save_split_manifest(), split_manifest_to_dict(), balanced_trial_subset() (+16 more)

### Community 9 - "Community 9"
Cohesion: 0.1
Nodes (13): Data schemas, split manifests, and leakage guards., _build_events(), from_checkpoint(), from_pretrained(), _load_local_config(), Build minimal local event rows for smoke/pipeline tests.          Text events ar, Compatibility shim returning local event rows, not a pandas DataFrame., Predict toy fMRI responses from event rows.          Event rows are converted to (+5 more)
...
- **Thin community `Community 22`** (3 nodes): `vendor_upstreams.py`, `_clone_or_checkout()`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (1 nodes): `Load a local NeuroTwin TRIBE-style config or seeded defaults.          No pretra`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (1 nodes): `Compatibility shim for TRIBE-style callers.          Prefer :meth:`from_checkpoi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 29`** (1 nodes): `Validate the artifact contract required before paper-mode claims.      This is i`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 30`** (1 nodes): `Validate cluster launch inputs before an expensive SLURM allocation runs.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (1 nodes): `Per-timepoint MLP baseline for neural windows.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 32`** (1 nodes): `Small Conv1D/TCN-style baseline with stable [batch, time, feature] IO.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (1 nodes): `Small Transformer baseline for CPU shape and smoke tests.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (1 nodes): `CPU debug stand-in for long-sequence SSM baselines until Mamba is pinned.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (1 nodes): `Modality-tokenizer + shared latent dynamics + modality-readout scaffold.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `run_prepared_training()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 7`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `_cmd_train()` connect `Community 1` to `Community 0`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 13`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `NeuralEventBatch` connect `Community 3` to `Community 5`, `Community 8`, `Community 12`, `Community 13`, `Community 15`?**
