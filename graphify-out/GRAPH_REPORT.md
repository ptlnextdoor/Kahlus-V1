...
## Corpus Check
- 74 files · ~38,845 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 608 nodes · 1317 edges · 33 communities detected
...
Cohesion: 0.08
Nodes (38): _baseline_catalog(), BaselineFailure, _cross_modal_task(), _fit_autoregressive_ridge(), _fit_ridge(), _fit_torch_sequence_model(), _flatten_time(), _future_task() (+30 more)
...
Cohesion: 0.1
Nodes (30): _cmd_data_prepare(), _cmd_data_smoke(), load_split_manifest(), record_from_dict(), record_to_dict(), save_data_manifest(), save_leakage_report(), save_split_manifest() (+22 more)
...
Cohesion: 0.15
Nodes (23): format_prepared_eval_audit(), _cmd_eval(), _add_concrete_seed_record(), _aggregate_rank(), _audit_payload(), _ci_violations(), _coerce_seed(), _finite_number() (+15 more)
...
## Knowledge Gaps
- **27 isolated node(s):** `Raised when an experiment config cannot be loaded or validated.`, `Resolve a source commit from git, falling back to COMMIT_HASH.txt.`, `Validate cluster launch inputs before an expensive SLURM allocation runs.`, `Write a cluster config with absolute prepared-manifest paths.`, `Closed-form ridge baseline for sanity checks and tiny CPU benchmarks.` (+22 more)
...
- **Why does `_cmd_train()` connect `Community 3` to `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 10`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `run_prepared_training()` connect `Community 5` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 12`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `PreparedSuiteConfig` connect `Community 12` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 10`?**
