# Graph Report - /Users/aayu/conductor/workspaces/kahlus-v1/abuja  (2026-05-28)

## Corpus Check
- 72 files · ~74,880 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 539 nodes · 1128 edges · 28 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 427 edges (avg confidence: 0.74)
...
Cohesion: 0.08
Nodes (36): _baseline_catalog(), BaselineFailure, _cross_modal_task(), _fit_neurotwin(), _fit_ridge(), _fit_torch_sequence_model(), _flatten_time(), _future_task() (+28 more)
...
Cohesion: 0.07
Nodes (32): _cmd_data_prepare(), _cmd_estimate(), _cmd_split_audit(), _cmd_train(), _config_value(), _has_prepared_training_inputs(), ConfigError, load_config() (+24 more)
...
Cohesion: 0.08
Nodes (23): cleanup_process_group(), DistributedInfo, get_distributed_info(), get_rank_metrics_path(), maybe_init_process_group(), unwrap_model(), wrap_ddp_if_initialized(), _aggregate_task_results() (+15 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (16): Run a tiny deterministic CPU training loop for CLI and CI smoke tests., run_synthetic_training(), TrainingSmokeResult, ModelMetadataGeometryTests, ModelShapeTests, TrainingSmokeTests, _build_backbone(), _build_modality_encoder() (+8 more)

### Community 7 - "Community 7"
Cohesion: 0.11
Nodes (23): audit_split_manifest(), AuditReport, _forbidden_metadata(), _metadata_group_overlap(), _window_overlap(), check_manifest_leakage(), LeakageReport, Check record reuse and held-out group overlap across train/val/test. (+15 more)
...
Cohesion: 0.16
Nodes (23): format_prepared_eval_audit(), _cmd_data_smoke(), _cmd_eval(), build_prepared_window_tasks(), _cross_modal_task_from_windows(), _dataset_site_generalization_from_windows(), _first_modality_with_splits(), format_prepared_baseline_report() (+15 more)

### Community 10 - "Community 10"
Cohesion: 0.21
Nodes (8): _cmd_cluster_preflight(), ClusterPreflightReport, _config_value(), format_cluster_preflight(), Validate cluster launch inputs before an expensive SLURM allocation runs., run_cluster_preflight(), _validate_manifest_path(), ClusterPreflightTests
...
## Knowledge Gaps
- **21 isolated node(s):** `Raised when an experiment config cannot be loaded or validated.`, `Validate cluster launch inputs before an expensive SLURM allocation runs.`, `Closed-form ridge baseline for sanity checks and tiny CPU benchmarks.`, `Per-timepoint MLP baseline for neural windows.`, `Small Conv1D/TCN-style baseline with stable [batch, time, feature] IO.` (+16 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 20`** (2 nodes): `main()`, `make_figures.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (1 nodes): `Per-timepoint MLP baseline for neural windows.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 22`** (1 nodes): `Small Conv1D/TCN-style baseline with stable [batch, time, feature] IO.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 23`** (1 nodes): `Small Transformer baseline for CPU shape and smoke tests.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (1 nodes): `CPU debug stand-in for long-sequence SSM baselines until Mamba is pinned.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (1 nodes): `Modality-tokenizer + shared latent dynamics + modality-readout scaffold.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (1 nodes): `Encode observed modalities into shared latent neural tokens.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `run_prepared_training()` connect `Community 5` to `Community 0`, `Community 2`, `Community 3`, `Community 6`, `Community 9`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **Why does `_cmd_train()` connect `Community 3` to `Community 2`, `Community 5`, `Community 6`, `Community 7`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `PreparedSuiteConfig` connect `Community 9` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 7`?**
