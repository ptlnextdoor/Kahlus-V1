...
## Summary
- 806 nodes · 1831 edges · 37 communities detected
...
- `NeuralEventBatch` --uses--> `Audit prepared eval inputs before any benchmark score is trusted.`  [INFERRED]
  /Users/aayu/conductor/workspaces/kahlus-v1/little-rock/src/neurotwin/data/schemas.py → src/neurotwin/eval/audit.py
...
- `NeuralStateSpaceTranslator` --uses--> `Run tiny local baselines on paired synthetic windows.      This is intentionally`  [INFERRED]
  /Users/aayu/conductor/workspaces/kahlus-v1/little-rock/src/neurotwin/models/torch_models.py → src/neurotwin/benchmarks/baseline_suite.py
- `NeuralStateSpaceTranslator` --uses--> `Run tiny local baselines on paired synthetic windows.      This is intentionally`  [INFERRED]
  /Users/aayu/conductor/workspaces/kahlus-v1/little-rock/src/neurotwin/models/torch_models.py → src/neurotwin/benchmarks/baseline_suite.py
- `NeuralStateSpaceTranslator` --uses--> `Run tiny local baselines on paired synthetic windows.      This is intentionally`  [INFERRED]
  /Users/aayu/conductor/workspaces/kahlus-v1/little-rock/src/neurotwin/models/torch_models.py → src/neurotwin/benchmarks/baseline_suite.py
...
Cohesion: 0.05
Nodes (53): _baseline_catalog(), BaselineFailure, _cross_modal_task(), _fit_autoregressive_ridge(), _fit_ridge(), _fit_torch_sequence_model(), _fit_tribe_style(), _flatten_time() (+45 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (52): audit_prepared_eval_inputs(), audit_split_manifest(), AuditReport, _forbidden_metadata(), _metadata_group_overlap(), PreparedEvalAuditReport, _window_overlap(), _cmd_data_prepare() (+44 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (58): bids_manifest_summary(), _events_for(), _infer_modality(), _is_bids_signal(), _listlike(), _load_timeseries_derivative(), _parse_entities(), _read_tsv() (+50 more)
...
Cohesion: 0.06
Nodes (32): _cmd_doctor(), _cmd_estimate(), ConfigError, load_config(), Raised when an experiment config cannot be loaded or validated., require_config_keys(), _check_runs_writable(), DoctorCheck (+24 more)
...
Cohesion: 0.08
Nodes (37): format_prepared_eval_audit(), _cmd_eval(), EvalCommandResult, _manifest_paths(), _prepared_suite_config(), _run_audit_command(), run_eval_command(), _run_neural_translation_v1_command() (+29 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (18): _fit_neurotwin(), Run a tiny deterministic CPU training loop for CLI and CI smoke tests., run_synthetic_training(), TrainingSmokeResult, ModelMetadataGeometryTests, ModelShapeTests, TrainingSmokeTests, _build_backbone() (+10 more)

### Community 10 - "Community 10"
Cohesion: 0.1
Nodes (35): _duplicate_metadata_value_violations(), _event_metadata_violations(), _forbidden_event_metadata_violations(), _hidden_subject_metadata_violations(), _prepared_windows_by_split(), Audit prepared eval inputs before any benchmark score is trusted., Audit prepared eval inputs before any benchmark score is trusted., _record_id() (+27 more)
...
- **Thin community `Community 23`** (1 nodes): `Load a local NeuroTwin TRIBE-style config or seeded defaults.          No pretra`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (1 nodes): `Compatibility shim for TRIBE-style callers.          Prefer :meth:`from_checkpoi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `_require_bundle_rel()` connect `Community 4` to `Community 7`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `run_prepared_training()` connect `Community 3` to `Community 1`, `Community 10`, `Community 9`, `Community 7`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `_cmd_train()` connect `Community 1` to `Community 8`, `Community 9`, `Community 3`, `Community 5`?**
