# Graph Report - /Users/aayu/conductor/workspaces/kahlus-v1/hyderabad  (2026-05-28)

## Corpus Check
- 73 files · ~78,877 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 563 nodes · 1181 edges · 34 communities detected
...
- `WindowSpec` --uses--> `Audit prepared eval inputs before any benchmark score is trusted.`  [INFERRED]
  /Users/aayu/conductor/workspaces/kahlus-v1/hyderabad/src/neurotwin/data/windows.py → src/neurotwin/eval/audit.py
...
Cohesion: 0.09
Nodes (32): Audit prepared eval inputs before any benchmark score is trusted., _cmd_data_prepare(), _cmd_data_smoke(), Persist prepared event batches for offline training/eval jobs., save_data_manifest(), save_leakage_report(), balanced_trial_subset(), _build_moabb_paradigm() (+24 more)
...
Cohesion: 0.09
Nodes (26): _cmd_cluster_preflight(), _cmd_estimate(), _cmd_split_audit(), _cmd_train(), _config_value(), _has_prepared_training_inputs(), _parse_split_windows(), ConfigError (+18 more)

### Community 6 - "Community 6"
Cohesion: 0.12
Nodes (21): audit_prepared_eval_inputs(), _prepared_windows_by_split(), PreparedEvalAuditReport, Audit prepared eval inputs before any benchmark score is trusted., _record_id(), _window_overlap_violations(), event_manifest_summary(), _jsonable() (+13 more)

### Community 7 - "Community 7"
Cohesion: 0.12
Nodes (25): build_prepared_window_tasks(), _cross_modal_task_from_windows(), _dataset_site_generalization_from_windows(), _first_modality_with_splits(), _future_task_from_windows(), _future_xy(), _group_windows(), _masked_task_from_windows() (+17 more)
...
- **Thin community `Community 24`** (2 nodes): `main()`, `make_figures.py`
...
- **Why does `run_prepared_training()` connect `Community 4` to `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 14`?**
  _High betweenness centrality (0.146) - this node is a cross-community bridge._
- **Why does `_cmd_train()` connect `Community 5` to `Community 2`, `Community 4`, `Community 6`, `Community 8`, `Community 14`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `PreparedSuiteConfig` connect `Community 7` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 8`?**
