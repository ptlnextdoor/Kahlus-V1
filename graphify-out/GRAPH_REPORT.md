...
## Corpus Check
- 75 files · ~43,360 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 690 nodes · 1539 edges · 37 communities detected
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 583 edges (avg confidence: 0.74)
...
Cohesion: 0.06
Nodes (39): _baseline_catalog(), _cross_modal_task(), _fit_autoregressive_ridge(), _fit_ridge(), _fit_torch_sequence_model(), _fit_tribe_style(), _flatten_time(), _future_task() (+31 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (32): BaselineFailure, _fit_neurotwin(), Run tiny local baselines on paired synthetic windows.      This is intentionally, Run tiny local baselines on paired synthetic windows.      This is intentionally, Run tiny local baselines on paired synthetic windows.      This is intentionally, Run tiny local baselines on paired synthetic windows.      This is intentionally, Small Conv1D/TCN-style baseline with stable [batch, time, feature] IO., Per-timepoint MLP baseline for neural windows. (+24 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (38): _cmd_cluster_preflight(), _cmd_doctor(), _cmd_estimate(), _cmd_train(), _config_value(), _has_prepared_training_inputs(), _parse_split_windows(), ConfigError (+30 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (41): bids_manifest_summary(), _events_for(), _infer_modality(), _is_bids_signal(), _listlike(), _load_timeseries_derivative(), _parse_entities(), _read_tsv() (+33 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (34): audit_prepared_eval_inputs(), _duplicate_metadata_value_violations(), _event_metadata_violations(), _forbidden_event_metadata_violations(), format_prepared_eval_audit(), _hidden_subject_metadata_violations(), _prepared_windows_by_split(), PreparedEvalAuditReport (+26 more)
...
Cohesion: 0.12
Nodes (29): _add_degenerate_ci(), _add_degenerate_task_metric_ci(), _aggregate_seed_metrics(), _aggregate_seed_ranks(), build_prepared_window_tasks(), _collect_metric_values(), _cross_modal_task_from_windows(), _csv_cell() (+21 more)
...
- **Thin community `Community 13`** (17 nodes): `ResearchArtifactTests`, `._assert_runner_archive()`, `._copy_repo_to_temp_git()`, `.test_a100_h100_configs_scripts_and_paper_docs_exist()`, `.test_a100_runbook_separates_fast_and_heavy_lanes()`, `.test_a100_slurm_scripts_require_safe_inputs()`, `.test_chapman_first_run_launcher_contains_required_sequence()`, `.test_claims_doc_blocks_forbidden_claims()`, `.test_moabb_benchmark_script_blocks_slurm_tmp_fallback()`, `.test_moabb_scripts_and_cluster_configs_use_benchmark_windows()`, `.test_operator_run_bundle_files_are_self_contained()`, `.test_package_a100_handoff_zip_smokes_real_archive()`, `.test_package_bundle_uses_head_archive_and_dirty_guard()`, `.test_package_runner_bundle_smokes_real_archive()`, `.test_runpod_rehearsal_is_budget_gated()`, `.test_tribe_style_does_not_become_required_dependency()`, `test_research_artifacts.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 17`** (9 nodes): `MoabbCliAndGeneralizationTests`, `.run_cli_no_check()`, `.test_dataset_site_generalization_task()`, `.test_moabb_prepare_missing_deps_fails_cleanly()`, `.test_moabb_smoke_missing_deps_fails_cleanly()`, `.test_neural_translation_suite_includes_generalization()`, `test_real_moabb_benchmark_script_creates_windows_and_tasks()`, `test_real_moabb_smoke_script_creates_windows()`, `test_moabb_cli_and_generalization.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `run_prepared_training()` connect `Community 6` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 9`, `Community 16`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `_cmd_train()` connect `Community 2` to `Community 1`, `Community 3`, `Community 4`, `Community 6`, `Community 8`, `Community 16`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `NeuralEventBatch` connect `Community 7` to `Community 9`, `Community 3`, `Community 4`, `Community 14`?**
