...
| F5 | Propofol sedation: complexity beyond spectral for awake vs sedated | Powered negative (full cohort) | 21/21 subjects (supersedes earlier 12/21 disk-limited partial), 2527 windows, n_boot=2000 | Awake −0.2072 [−0.3084, −0.1208]; sedated −0.2072 [−0.3077, −0.1198] bits | `artifacts/propofol_pci_state/` | `propofol_pci.py` | `finding/propofol-pci-powered-negative-v1` |
