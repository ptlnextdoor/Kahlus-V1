...
| Label | Commit | Experiment | Kind | Status | GPUs | Steps | Best Task | Best Val MSE | Test MSE | Test Pearson r | Claim Allowed |
| --- | --- | --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: | --- |
| `423248a` | `423248a119463581c4526ccfb4e35b47de46d121` | `moabb_a100_smoke` | A100 smoke | `completed_prepared_training` | 1 | 50 | `future_state_forecasting` | 39.819112 | 46.233087 | 0.376921 | false |
| `7de1e50` | `7de1e5081591ad1a763a37c0211f84ac677f3e73` | `moabb_a100_smoke` | A100 smoke | `completed_prepared_training` | 1 | 50 | `future_state_forecasting` | 39.819112 | 46.233087 | 0.376921 | false |
| `82e2f0b` | `82e2f0b4baba8796c09ec27e98592db53ad3a002` | `moabb_a100_smoke` | A100 smoke | `completed_prepared_training` | 6 | 50 | `future_state_forecasting` | 38.411555 | 43.449179 | 0.458321 | false |
| `822a80e` | `822a80e47f87e59fbc8f9cea9b1a15cada4b6c73` | `moabb_a100` | A100 full | `failed_6gpu_torchrun_training` | 6 | 50000 configured | n/a | n/a | n/a | n/a | n/a |
| `6621642-ddpfix` | `66216425136fed888a8511d298c3cf3fbc877987` | `moabb_a100_3gpu_batchmatched_ddpfix_resume` | A100 DDP finalize recovery | `completed_prepared_training` | 3 | 100000 | `future_state_forecasting` | 2.228651 | 28.546603 | 0.479801 | false |
