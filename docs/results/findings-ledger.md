...
| F5 | Propofol sedation: complexity beyond spectral for awake vs sedated | Underpowered (disk-limited) | OpenNeuro ds005620: **2/21 subjects** downloaded; claim bootstrap on partial cohort | Awake RFS −0.206 [CI −0.413, 0.507]; not powered (need ≥8 subjects) | `artifacts/propofol_pci_state/` | `propofol_pci.py` | `finding/propofol-pci-underpowered-v1` |
