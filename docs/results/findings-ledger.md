...
| F5 | Propofol sedation: complexity beyond spectral for awake vs sedated | Powered negative | OpenNeuro ds005620: **12/21 subjects**, 1298 windows, claim bootstrap (n_boot=2000) | Awake RFS −0.174 [CI −0.314, −0.050]; sedated −0.174 [CI −0.306, −0.047]; CIs exclude 0 on the negative side | `artifacts/propofol_pci_state/` | `propofol_pci.py` | `finding/propofol-pci-powered-negative-v1` |
