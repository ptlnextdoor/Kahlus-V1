...
It inventories evidence zips under ~/Downloads/versions by default, normalizes the
...
DEFAULT_VERSIONS_ROOT = Path.home() / "Downloads" / "versions"
...
PYTHONPATH=src python scripts/render_eeg_v1_ridge_visuals.py \
  --versions-root ~/Downloads/versions \
